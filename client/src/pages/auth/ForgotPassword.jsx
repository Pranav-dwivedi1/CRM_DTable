...
import { Mail, AlertCircle, CheckCircle, ArrowRight, Activity, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 relative overflow-hidden px-4">
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2 text-sm">Recover your user account password</p>
        </div>
        ...
        <div className="glass-panel rounded-3xl p-8 glow-primary">
          {success ? (
            <div className="text-center py-4">
              ...
              <h2 className="text-xl font-semibold text-white mb-3">Check Reset Link</h2>
              <p className="text-slate-300 text-sm mb-6 leading-relaxed">
                If the email is registered, we've logged a password reset link to the server console. 
                In a production build, this email would be sent to your inbox.
              </p>
              <Link
                to="/login"
            ...
            <>
              <div className="flex items-center gap-2 mb-6">
                <Link to="/login" className="p-1.5 rounded-lg bg-slate-900 border border-slate-800 text-slate-400 hover:text-white transition-colors">
              ...
              <p className="text-sm text-slate-400 mb-6">
                Enter your email address below and we'll generate a reset link for you.
              </p>
