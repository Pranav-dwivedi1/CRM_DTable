...
import {
  LayoutDashboard, Target, Users, Settings, LogOut, Activity, User,
  ChevronDown, ChevronRight, BarChart2, PlusCircle, CalendarClock,
    ...
    <aside className="w-64 shrink-0 h-screen sticky top-0 glass-panel border-r border-slate-800 flex flex-col justify-between z-20">
      <div className="flex flex-col min-h-0 flex-1">
        ...
        <div className="p-6 border-b border-slate-800/80 flex items-center gap-3 shrink-0">
          ...
          <div>
            <h2 className="text-md font-bold font-display text-white tracking-tight leading-none">TenantFlow</h2>
